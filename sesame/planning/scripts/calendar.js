const __CALENDAR__ = [
    {
        ...
        description : "A better way for administrators to manage your datas",
        content : [
            {
                txt : {
                    title : "Sesadmin",
                    description : "A tool for the administrators to manage the datas from the web"
                },
    ...
    },
    {
        ...
        content : [
            ...
            {
                txt : {
                    title : "Datas empowering",
                    description : "Sesame database will grow stronger, allowing people to access a more powerful range of datas."
                },
